...
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot operator a class as a function"); } }
...
var Actions = /*#__PURE__*/function () {
  function Actions(delegate, context, options) {
    ...
    this.options = options; // Allow override to operator parent logic
